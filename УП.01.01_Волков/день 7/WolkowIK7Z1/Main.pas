...
begin
  case SUM of
    0 .. 2:
      Panel2.Caption := 'Плохо! Количество правильных ответов : ' +
        IntToStr(SUM);
    3:
      Panel2.Caption := 'Удовлетворительно!Количество правильных ответов : ' +
        IntToStr(SUM);
    4:
      Panel2.Caption := 'Хорошо!Количество правильных ответов : ' +
        IntToStr(SUM);
    5:
      Panel2.Caption := 'Отлично! Количество правильных ответов : ' +
        IntToStr(SUM);
  end;
  case SUM of
    0 .. 2:
